...
public class ListBox : MonoBehaviour
{
	...
	public ListPositionCtrl _positionCtrl;
	public BaseListBank _listBank;
	...
	public float _unitPos; // The distance between boxes
	public float _lowerBoundPos; // The left/down-most position of the box
	public float _upperBoundPos; // The right/up-most position of the box
								 // _changeSide(Lower/Upper)BoundPos is the boundary for checking that
								 // whether to move the box to the other end or not
	public float _changeSideLowerBoundPos;
	public float _changeSideUpperBoundPos;
